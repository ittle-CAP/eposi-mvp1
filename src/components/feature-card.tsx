...
const FeatureCard = ({ title, description, icon }: FeatureCardProps) => {
  ...
  return (
    <div className="group relative h-[120px] overflow-hidden rounded-xl bg-white/95 backdrop-blur-sm p-6 shadow-lg transition-all duration-300 hover:h-[180px] hover:shadow-xl hover:bg-white">
